...
from .assets.blocks.residual2plus1d_d import Residual2Plus1DD
...
class ResNet182Plus1DD(tf.keras.Model):

    """

    Custom ResNet18 Network with Conv2Plus1D Convolutions and Residual blocks. 
    ...
    def __init__(self, units: int = 256, **kwargs) -> None:
        ...
        Constructor of the ResNet182Plus1DD network.
        ...
        # Backbone
        ## Stage 1
        self.block = Residual2Plus1DD(filters=64, strides=(1, 1, 1))
        ## Stage 2
        self.block1 = Residual2Plus1DD(filters=128, strides=(1, 2, 2))
        self.block2 = Residual2Plus1DD(filters=128, strides=(1, 1, 1))
        ## Stage 3
        self.block3 = Residual2Plus1DD(filters=256, strides=(1, 2, 1))
        self.block4 = Residual2Plus1DD(filters=256, strides=(1, 1, 1))
        ## Stage 4
        self.block5 = Residual2Plus1DD(filters=512, strides=(1, 2, 2))
        self.block6 = Residual2Plus1DD(filters=512, strides=(1, 1, 1))
    ...
    def build(self, input_shape: Union[tf.TensorShape, tuple[int, int, int, int, int]]) -> None:
        ...
        Build method of the ResNet182Plus1DD network.
    ...
    def call(self, inputs: tf.Tensor) -> tf.Tensor:
        ...
        Call method of the ResNet182Plus1DD network.
    ...
    def get_config(self) -> dict[str, Any]:
        ...
        Method to get the configuration of the ResNet182Plus1DD network.
        ...
        -------
        config : dict
            Configuration of the ResNet182Plus1DD network.
    ...
    def from_config(cls, config):
        ...
        Method to set the configuration of the ResNet182Plus1DD network.
        ...
        model : tf.keras.Model
            The Loaded ResNet182Plus1DD network.
    ...
    def get_build_config(self) -> dict[str, Any]:
        ...
        Method to get the build configuration of the ResNet182Plus1DD network.
    ...
    @classmethod
    def build_from_config(cls, config: dict[str, Any]) -> "ResNet182Plus1DD":

        """

        Method to set the build configuration of the ResNet182Plus1DD network.
