...
class Residual2Plus1DD(tf.keras.layers.Layer):

    """

    Residual2Plus1DD block inspired from the paper "Bag of Tricks for Image Classification with Convolutional Neural Networks"
    ...
    def __init__(self, filters: int, strides: tuple[int, int, int],**kwargs) -> None:
        ...
        Constructor of the Residual2Plus1DD block.
        ...
        # Main Path
        self.feature_extract = Conv2Plus1DLayer(filters=self.filters, 
                                                kernel_size=(3, 3, 3), 
                                                strides=(1, 1, 1),
                                                padding="same",
                                                use_bias=False, 
                                                ...
                                                activation="relu")
        self.feature_extract1 = Conv2Plus1DLayer(filters=self.filters, 
                                                 kernel_size=(3, 3, 3), 
        ...
        self.shortcut = Conv2Plus1DLayer(filters=self.filters, 
                                         kernel_size=(1, 1, 1), 
                                         strides=(1, 1, 1), 
                                         padding="same",
                                         use_bias=False, 
    ...
    def build(self, input_shape: Union[tf.TensorShape, tuple[int, int, int, int, int]]) -> None:
        ...
        Build method of the Residual2Plus1DD block.
    ...
    def call(self, X: tf.Tensor) -> tf.Tensor:
        ...
        Call method of the Residual2Plus1DD block.
    ...
    def compute_output_shape(self, input_shape: Union[tf.TensorShape, tuple[int, int, int, int, int]]) -> tuple[int, int, int, int, int]:
        ...
        Method to compute the output shape of the Residual2Plus1DD block.
    ...
    def get_config(self) -> dict[str, Any]:
        ...
        """
         ...
         Method to get the configuration of the Residual2Plus1DD block.
        ...
        -------
        config : dict
            Configuration of the Residual2Plus1DD block.
    ...
    def get_build_config(self) -> dict[str, Any]:
        ...
        """
         ...
         Method to get the build configuration of the Residual2Plus1DD block.
