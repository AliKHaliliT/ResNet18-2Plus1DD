...
class Conv2Plus1DLayer(tf.keras.layers.Layer):
    ...
    A simple custom Conv layer containing Conv2Plus1D, a Normalizarion layer and an Activation at the end.
    ...
    def __init__(self, filters: int, kernel_size: tuple[int, int, int], 
        ...
        self.convolution = _Conv2Plus1D(filters=self.filters, kernel_size=self.kernel_size, 
