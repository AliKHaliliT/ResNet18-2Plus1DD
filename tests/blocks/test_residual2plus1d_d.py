import unittest
from ResNet182Plus1DD.assets.blocks.residual2plus1d_d import Residual2Plus1DD
import tensorflow as tf
import inspect


class TestResidual2Plus1DD(unittest.TestCase):

    def test_creation_init_layer(self):

        # Arrange and Act
        layer = Residual2Plus1DD(filters=1, strides=(1, 1, 1))
    ...
    def test_output_tensor_intended__shape(self):
        ...
        # Act
        output = Residual2Plus1DD(filters=filters, strides=strides)(input_tensor)
    ...
    def test_get__config_init_matching__dict(self):
        ...
        init_params = [
            param.name
            for param in inspect.signature(Residual2Plus1DD.__init__).parameters.values()
